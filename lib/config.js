...
module.exports = {
  ...
  // De mo khoa dia chi luong, yt-dlp phai chay mot doan JavaScript cua YouTube
  // bang bo giai 'EJS'. Anh Docker cai san goi yt-dlp-ejs; khi goi do thieu hoac
  // qua cu so voi ban yt-dlp dang chay thi cho no tai ban dung tu GitHub. Dat 0
  // de cam han viec tai — luc do may chu phai co san goi yt-dlp-ejs.
  YTDLP_REMOTE_EJS: process.env.YTDLP_REMOTE_EJS !== '0',
  ...
  // Trang video cho danh sach luong (yt-dlp) bao lau roi thi ve truoc ma khong
  // cho nua. yt-dlp phai chay han mot tien trinh Python roi hoi YouTube may
  // lan, tren NAS yeu la vai giay — trong khi phan chu cua trang chi mat nua
  // giay. Xem chi tiet o server.js.
  WATCH_WAIT_MS: Number(process.env.WATCH_WAIT_MS || 1200),
  ...
  // Da dang nhap thi trang chinh hien goi y rieng cua tai khoan do. Moi lan lay
  // la mot lan goi yt-dlp (vai giay tren NAS yeu, nho la co dem 10 phut cho moi
  // may). Dat HOME_FEED=0 de tat, luc do trang chinh chi con danh sach chu de.
  HOME_FEED: process.env.HOME_FEED !== '0',
  ...
  // Dinh sau /s60.css, /mini.css, /s60.js va /hd.js de may khong dung lai ban
  // cu trong bo dem.
  ASSET_TAG: assetTag(['s60.css', 'mini.css', 's60.js', 'hd.js']),
