...
function aboutPage({ ffmpegOk, cookiesOk, address, build, buildDate, ytdlpVersion }) {
...
<tr><td class="tx">Bản đang chạy</td><td class="tx">${escapeHtml(build)}</td></tr>
${
  buildDate
    ? `<tr><td class="tx">Dựng lúc</td><td class="tx">${escapeHtml(buildDate)}</td></tr>`
    : ''
}
<tr><td class="tx">yt-dlp</td><td class="tx">${escapeHtml(ytdlpVersion)}</td></tr>
