 ...
 *  - Man hinh E6 rong 480 diem: chi mot cot the tu tren xuong. Rieng trong
 *    tung the thi chia doi — anh ben trai, chu ben phai — cho do phai cuon.
 *
...
/**
 * Cot chu chi con hon mot nua be ngang the: tieu de dai qua thi the cao gap
 * doi anh, mot man hinh chi con nhin duoc hai video. Chu cang to thi cang
 * phai cat som.
 */
const TITLE_CHARS = {
  m: { thumbs: 84, wide: 110 },
  l: { thumbs: 64, wide: 90 },
  xl: { thumbs: 46, wide: 68 },
};
