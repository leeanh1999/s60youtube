...
const SHAPES = {
  ...
  // Chinh hinh 'back' lat qua duong cheo: mui nhon quay len thay vi quay sang
  // trai. Giu cung do day net nen dat canh cac hinh khac khong lech.
  up: '<path d="M3.9 14.8 12 6.7l8.1 8.1-2.2 2.2L12 11.1l-5.9 5.9z"/>',
